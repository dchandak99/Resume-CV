...
\begin{itemize}
    ...
    \item Introduced the notion of biprocesses (\textit{semantics and translation}) and diff equivalence in SAPIC, and worked on the soundness proof of the translation after the addition 
    \end{itemize}
}
\vspace{1mm}
