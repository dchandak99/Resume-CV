...
\vspace{-18.5pt}
\begin{itemize}[itemsep = -1 mm, leftmargin=*]
    \item Shared Task on \textbf{Multi-Hop Inference} for \textbf{Explanation Regeneration}:%\hfill{\sl \small \textsc{Personal Project}}
    \vspace{-7pt}
...
\end{itemize}
\vspace{-5pt}
\textbf{PCA for Fruit Image Generation and MNIST} \hfill{\sl \small (Oct - Nov '19)}
\vspace{-0.5pt}\\
...
%\end{itemize}
\vspace{-5pt}
\textbf{Non Parametric Estimation \& Cross Validation} \hfill{\sl \small (Sept - Oct '19)}
\vspace{-0.5pt}\\
...
\begin{tabular}{p{3cm} p{17cm}}
    \textbf{Languages} & \textsc{C++, Python, Java, Bash, Matlab, Vhdl}  \\
