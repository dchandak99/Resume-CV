...
\vspace{-19pt}
\begin{itemize}[itemsep = -1 mm, leftmargin=*]
  \item Compared non paramteric estimation techniques of histogramming and Kernel Density Estimation and anaylzed the \textit{rate of convergence} and their optimum value
