...
\vspace{-19pt}
\begin{itemize}[itemsep = -1 mm, leftmargin=*]
    \item Formal {\bf Verification} of security protocols:
    \vspace{-8pt}
...
\begin{itemize}[itemsep = -1 mm, leftmargin=*]
    ...
    \end{itemize}
\end{itemize}
\newgeometry{bottom = 0.3in,left = 0.4in,right = 0.4in,top = 0.4in}
%\vspace{-5pt}
...
\begin{tabular}{p{3cm} p{17cm}}
    ...
    \textbf{Software Tools} & \textsc{Git, \LaTeX, Sed, Awk, Makefiles, Scipy, ns3, z3, Wireshark, Proverif, Tamarin, Sapic}\\
\end{tabular}
